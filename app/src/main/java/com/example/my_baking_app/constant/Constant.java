package com.example.my_baking_app.constant;
...
public class Constant {
    ...
    public static final String RECIPIENAME="name";
    public static final String APPLICATION_ID ="com.example.my_baking_app";
}
